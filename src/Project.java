...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/images/pvpp.jpeg"));
...
//       exam details
        ...
        JMenuItem ut3 = new JMenuItem("Web Browser(error)");
