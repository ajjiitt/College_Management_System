...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/images/fifth.jpeg"));
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        String course[] = {"B.E","BBA","BCA","Bsc","Msc","MBA","MCA","BA","BCom"};
