...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            JLabel l5 = new JLabel("COMPS-A  BATCH-B");
            ...
            JLabel l6 = new JLabel("Developed By :Ajit Madhu Darshana Rahul");
            ...
            JLabel l8 = new JLabel("Contact :9876543210");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Under-Manjiri Mam ");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("PVPPCOE,Sion(East),Mumbai");
